---
title: "About Me"
description: "Journey from Software Engineering student to DevOps Engineer. Passionate about building containerized, scalable infrastructure and CI/CD pipelines."
layout: "page"
showHero: true
...
Hello! I am **Nguyen Phuong Thao** (Theor Nguyen), a Software Engineering student at FPT University, focused on becoming a true DevOps Engineer.

With a solid background in Backend development (Java/Spring Boot, Node.js) and a passion for Cloud infrastructure (AWS), I always look for ways to automate every process to bridge the gap between the first line of code and the final product on Production.

Here are some key milestones on my journey:
